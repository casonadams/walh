...
call s:hi('Constant', s:dark_red)
call s:hi('String', s:dark_red)
call s:hi('Character', s:dark_red)
call s:hi('Number', s:dark_red)
call s:hi('Boolean', s:dark_red)
call s:hi('Float', s:dark_red)

call s:hi('Statement', s:dark_yellow)
call s:hi('Conditional', s:dark_yellow)
call s:hi('Repeat', s:dark_yellow)
call s:hi('Label', s:dark_yellow)

call s:hi('Operator', s:dark_yellow)
call s:hi('Keyword', s:dark_yellow)
call s:hi('Exception', s:dark_yellow)

call s:hi('PreProc', s:dark_magenta)
call s:hi('Include', s:dark_magenta)
call s:hi('Define', s:dark_magenta)
call s:hi('Macro', s:dark_magenta)
call s:hi('PreCondit', s:dark_magenta)

call s:hi('Type', s:dark_green)
call s:hi('StorageClass', s:dark_green)
call s:hi('Structure', s:dark_green)
call s:hi('Typedef', s:dark_green)
