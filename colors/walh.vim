...
highlight CursorLineNr guifg=#C9B5A5 guibg=#332D28 guisp=NONE gui=NONE
...
highlight Error guifg=#C9B5A5 guibg=#AE5E4F guisp=NONE gui=NONE
highlight ErrorMsg guifg=#C9B5A5 guibg=#AE5E4F guisp=NONE gui=NONE
...
highlight Identifier guifg=#C9B5A5 guibg=NONE guisp=NONE gui=NONE
...
highlight Normal guifg=#C9B5A5 guibg=#2A2520 guisp=NONE gui=NONE
...
highlight TSSymbol guifg=#C9B5A5 guibg=NONE guisp=NONE gui=italic
highlight TSURI guifg=#8197BD guibg=NONE guisp=NONE gui=underline
highlight TSVariableBuiltin guifg=#C9B5A5 guibg=NONE guisp=NONE gui=italic
...
highlight Error guifg=#C9B5A5 guibg=#9C5446 guisp=NONE gui=NONE
highlight ErrorMsg guifg=#C9B5A5 guibg=#9C5446 guisp=NONE gui=NONE
highlight Folded guifg=#6A5F55 guibg=#332D28 guisp=NONE gui=NONE
