...
call s:hi('Constant', s:light_cyan)
call s:hi('String', s:light_cyan)
call s:hi('Character', s:light_cyan)
call s:hi('Number', s:light_cyan)
call s:hi('Boolean', s:light_cyan)
call s:hi('Float', s:light_cyan)

call s:hi('Statement', s:light_green)
call s:hi('Conditional', s:light_green)
call s:hi('Repeat', s:light_green)
call s:hi('Label', s:light_green)

call s:hi('Operator', s:light_green)
call s:hi('Keyword', s:light_green)
call s:hi('Exception', s:light_green)

call s:hi('PreProc', s:dark_yellow)
call s:hi('Include', s:dark_yellow)
call s:hi('Define', s:dark_yellow)
call s:hi('Macro', s:dark_yellow)
call s:hi('PreCondit', s:dark_yellow)

call s:hi('Type', s:light_yellow)
call s:hi('StorageClass', s:light_yellow)
call s:hi('Structure', s:light_yellow)
