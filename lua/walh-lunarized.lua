...
local theme = lush(function()
  return {
    ...
    IncSearch    { fg =c.background, bg = c.orange }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    ...
    Todo           { fg = c.magenta, gui = "bold,underline" }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
