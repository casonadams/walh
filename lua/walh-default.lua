...
c.foreground = c.base.desaturate(90).lighten(60)
c.background = c.base.desaturate(90).darken(60)
c.red = c.base.rotate(0).desaturate(25).lighten(10)
c.yellow = c.base.rotate(50).saturate(50)
c.green = c.base.rotate(100).desaturate(50)
c.blue = c.base.rotate(200).desaturate(25).lighten(25)
c.magenta = c.base.rotate(310).desaturate(75).lighten(25)
...
local theme = lush(function()
  return {
    ...
    CursorLine   { bg = c.background.lighten(10) }, -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
    ...
    Folded       { fg = c.blue, bg = c.background.lighten(10) }, -- line used for closed folds
    FoldColumn   { fg = c.blue, bg = c.background.lighten(10) }, -- 'foldcolumn'
    ...
    CursorLineNr { fg = c.foreground.darken(30), bg = c.background.lighten(10) }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    StatusLine   { fg = c.foreground, bg = c.background.lighten(10) }, -- status line of current window
    StatusLineNC { fg = c.foreground.darken(30), bg = c.background }, -- status line of current window
    TabLine      { bg = c.background.lighten(10) }, -- tab pages line, not active tab page label
    ...
    VisualNOS    { bg = c.background.lighten(10) }, -- Visual mode selection when vim is "Not Owning the Selection".
